      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-card/80 backdrop-blur-sm border rounded-2xl shadow-xl shadow-black/5 p-8 animate-fade-in animation-delay-100">
          ...
          <div className="mt-6 pt-5 border-t">
            <p className="text-xs text-muted-foreground text-center mb-3">כניסה מהירה לדמו</p>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => fillDemo('admin')}
                className="py-2 px-3 text-xs rounded-lg border hover:bg-accent transition-colors font-medium"
              >
                👤 מנהל
              </button>
              <button
